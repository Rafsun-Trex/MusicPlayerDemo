...
struct SongInfo {
    ...
    var songImage: MPMediaItemArtwork
    var songId   :  NSNumber
}
        ...
        for album in albumItems {
            ...
            for song in albumItems {
                ...
                let songInfo: SongInfo = SongInfo(
                    ...
                    songImage: song.value(forProperty: MPMediaItemPropertyArtwork) as! MPMediaItemArtwork,
                    songId:     song.value( forProperty: MPMediaItemPropertyPersistentID ) as! NSNumber
                )
                songs.append( songInfo )
            }

            let albumInfo: AlbumInfo = AlbumInfo(albumTitle: albumTitle, songs: songs)
